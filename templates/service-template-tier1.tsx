// TEMPLATE A: TIER 1 (PREMIUM) - For high-value services like Interior Painting, Exterior Painting, Hand Painted Kitchens
...
const serviceData = {
  name: '[SERVICE NAME]',
  icon: '🎨',
  intro: '[150-word SEO-optimized intro with keywords for London & Hertfordshire]',
  serviceCards: [
    {
  ...
  faqs: [
    ...
    { question: '[FAQ 7]', answer: '[Answer 7]' }
  ],
  testimonials: [
    { name: 'Client 1', location: 'N8', rating: 10, text: '[Testimonial 1]' },
    { name: 'Client 2', location: 'EN5', rating: 10, text: '[Testimonial 2]' },
    { name: 'Client 3', location: 'W12', rating: 9, text: '[Testimonial 3]' }
  ]
};

export default function ServiceTier1Template() {
