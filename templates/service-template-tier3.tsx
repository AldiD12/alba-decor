// TEMPLATE C: TIER 3 (BASIC) - For smaller/specialized services like Wood Staining, Door Painting, Deck Painting
...
const serviceData = {
  name: '[SERVICE NAME]',
  icon: '🎨',
  intro: '[75-word intro with keywords]',
  serviceCard: {
    title: '[Main Service Focus]',
...
export default function ServiceTier3Template() {
