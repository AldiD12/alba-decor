// Lightweight SVG icons to replace heavy Lucide icons where possible
...
export const StarIcon = ({ className = "w-4 h-4", filled = false }: { className?: string; filled?: boolean }) => (
