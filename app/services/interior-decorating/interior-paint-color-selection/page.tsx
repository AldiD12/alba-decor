// TIER 3 (BASIC) - Interior Paint Color Selection Service
...
const serviceData = {
  name: 'Interior Paint Color Selection',
  icon: '🎨',
  intro: 'Expert color consultation services to help you choose the perfect paint colors for your interior spaces. Our professional color consultants provide personalized guidance to create harmonious and beautiful color schemes throughout London and Hertfordshire.',
  serviceCard: {
    title: 'Professional Color Consultation Services',
    description: 'Our experienced color consultants work with you to select paint colors that complement your style, lighting, and furnishings. We consider factors like room function, natural light, and personal preferences to create the perfect color palette.',
    features: [
      'Personalized color consultation sessions',
      'Color scheme development and coordination',
      'Paint sample testing and evaluation',
      'Professional color matching services'
    ]
  },
  process: [
    { step: '01', title: 'Initial Consultation', description: 'Discuss your style preferences and room requirements' },
    { step: '02', title: 'Color Selection', description: 'Professional guidance on color choices and combinations' },
    { step: '03', title: 'Sample Testing', description: 'Test selected colors in your actual lighting conditions' }
  ],
  benefits: [
    'Expert guidance from professional color consultants',
    'Avoid costly color mistakes and repainting',
    'Create cohesive color flow throughout your home',
    'Maximize the impact of natural and artificial lighting'
  ]
};

export default function InteriorPaintColorSelectionPage() {
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center gap-4 mb-6">
              ...
              <span className="text-alba-gold font-semibold text-sm tracking-wider uppercase">Color Consultation</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-alba-charcoal/80 text-lg">
              Professional color consultation process
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="font-display text-heading-mobile md:text-4xl font-bold text-alba-primary mb-12 text-center">
              Why Choose Professional Color Selection
            </h2>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-alba-charcoal/80 mb-12">
              We provide color consultation services across London, Hertfordshire, and the M25 area
            </p>
      ...
      <section className="py-20 md:py-28 bg-alba-primary text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-display text-heading-mobile md:text-5xl font-bold mb-6">
            Ready for Expert Color Guidance?
          </h2>
          <p className="text-subheading-mobile text-alba-cream/90 max-w-2xl mx-auto mb-8">
            Contact Alba Homes today for professional color consultation services in London and Hertfordshire.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button onClick={handleGetQuote} className="bg-alba-gold hover:bg-alba-accent text-alba-primary font-semibold">
              Get Free Quote
