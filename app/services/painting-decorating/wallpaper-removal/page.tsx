        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-body-mobile text-alba-charcoal/80 max-w-3xl mx-auto mb-8">
              Safe and efficient wallpaper removal services for all types of wallpaper. Our experienced team uses professional techniques and tools to remove old wallpaper without damaging your walls, preparing them perfectly for new decoration.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-elegant">
              <h3 className="font-display text-xl font-bold text-alba-primary mb-4">Safe Removal Methods</h3>
              <p className="text-alba-charcoal/70 mb-6">Professional techniques that protect your walls during removal.</p>
              <ul className="space-y-2">
                {['Steam removal method', 'Chemical stripping', 'Scoring techniques', 'Wall protection'].map((feature, index) => (
            ...
            <div className="bg-white p-8 rounded-2xl shadow-elegant">
              ...
              <p className="text-alba-charcoal/70 mb-6">Complete wall preparation after wallpaper removal.</p>
              <ul className="space-y-2">
                {['Adhesive removal', 'Wall cleaning', 'Surface smoothing', 'Repair work'].map((feature, index) => (
                  <li key={index} className="flex items-center gap-3 text-sm">
                    <Check className="w-4 h-4 text-alba-accent" />
                    {feature}
                  </li>
