...
export default function DoorPaintingPage() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="flex items-center gap-4 mb-6">
                ...
                <span className="text-alba-accent font-semibold text-sm tracking-wider uppercase">Door Painting</span>
              </div>
              
              <h1 className="font-display text-hero-mobile md:text-6xl font-bold text-alba-primary mb-6">
                Expert Door Painting
              ...
              <p className="text-body-mobile text-alba-charcoal/80 mb-8 leading-relaxed">
                Transform your home's entrance with professional door painting services. From front doors to interior doors, we provide expert preparation, priming, and painting using high-quality paints that ensure durability and a flawless finish that enhances your home's curb appeal.
              </p>
            ...
            <div className="relative">
              <div className="bg-white p-2 rounded-2xl shadow-elegant">
                <img
                  ...
                  alt="Professional door painting service"
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-elegant">
              <h3 className="font-display text-xl font-bold text-alba-primary mb-4">Front Door Painting</h3>
              <p className="text-alba-charcoal/70 mb-6">Enhance your home's curb appeal with professional front door painting using weather-resistant paints.</p>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-elegant">
              <h3 className="font-display text-xl font-bold text-alba-primary mb-4">Interior Door Painting</h3>
              <p className="text-alba-charcoal/70 mb-6">Professional interior door painting to match your home's decor and style preferences.</p>
              <ul className="space-y-2">
                <li className="flex items-center gap-3 text-sm text-alba-charcoal/80">
                  <Check className="w-4 h-4 text-alba-accent flex-shrink-0" />
            ...
            <div className="bg-white p-8 rounded-2xl shadow-elegant">
              <h3 className="font-display text-xl font-bold text-alba-primary mb-4">Door Restoration</h3>
              <p className="text-alba-charcoal/70 mb-6">Complete door restoration including repair, preparation, and painting for like-new results.</p>
              <ul className="space-y-2">
                <li className="flex items-center gap-3 text-sm text-alba-charcoal/80">
                  <Check className="w-4 h-4 text-alba-accent flex-shrink-0" />
                  Surface preparation
      ...
      <section className="py-20 md:py-28 bg-alba-primary text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-display text-heading-mobile md:text-5xl font-bold mb-6">
            Ready for Professional Door Painting?
          </h2>
          <p className="text-subheading-mobile text-alba-cream/90 max-w-2xl mx-auto mb-8">
            Get a free consultation and quote for expert door painting services across London and Hertfordshire.
          </p>
