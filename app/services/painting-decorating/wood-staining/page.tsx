// TIER 3 (BASIC) - Wood Staining Service
...
const serviceData = {
  name: 'Wood Staining',
  icon: '🪵',
  intro: 'Enhance the natural beauty of wood with our expert staining services. We provide professional wood staining for floors, furniture, decking, and architectural features, using premium stains that protect while highlighting the wood\'s natural grain and character throughout London and Hertfordshire.',
  serviceCard: {
    title: 'Professional Wood Staining Services',
    description: 'Our skilled craftsmen use premium wood stains and proven techniques to enhance and protect your wooden surfaces. From interior floors to outdoor decking, we deliver beautiful, long-lasting results that showcase the natural beauty of wood.',
    features: [
      'Premium quality wood stains and finishes',
      'Expert surface preparation and sanding',
      'Color matching and custom stain mixing',
      'Professional application techniques'
    ]
  },
  process: [
    { step: '01', title: 'Surface Assessment', description: 'Thorough inspection and preparation of wood surfaces' },
    { step: '02', title: 'Stain Application', description: 'Professional application using premium stains' },
    { step: '03', title: 'Quality Finish', description: 'Final inspection and protective coating application' }
  ],
  benefits: [
    'Enhances natural wood grain and beauty',
    'Provides long-lasting protection against wear',
    'Professional color matching services',
    'Eco-friendly stain options available'
  ]
};

export default function WoodStainingPage() {
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center gap-4 mb-6">
              ...
              <span className="text-alba-gold font-semibold text-sm tracking-wider uppercase">Professional Service</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-alba-charcoal/80 text-lg">
              Professional {serviceData.name.toLowerCase()} with attention to detail
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-alba-charcoal/80 mb-12">
              We provide {serviceData.name.toLowerCase()} services across London, Hertfordshire, and the M25 area
            </p>
