// TIER 3 (BASIC) - Wallpaper Repair Service
...
const serviceData = {
  name: 'Wallpaper Repair',
  icon: '🔧',
  intro: 'Professional wallpaper repair services to fix tears, bubbles, peeling edges, and pattern mismatches. We restore your wallpaper to perfect condition with expert patching and seamless repairs throughout London and Hertfordshire.',
  serviceCard: {
    title: 'Expert Wallpaper Repair Services',
    description: 'Our skilled technicians can repair virtually any wallpaper damage, from small tears and bubbles to larger sections requiring patching. We match patterns perfectly and ensure invisible repairs that restore your walls to their original beauty.',
    features: [
      'Tear and rip repair with invisible seams',
      'Bubble removal and re-adhesion',
      'Peeling edge restoration',
      'Pattern matching for patch repairs'
    ]
  },
  process: [
    { step: '01', title: 'Damage Assessment', description: 'Evaluate the extent and type of wallpaper damage' },
    { step: '02', title: 'Repair Planning', description: 'Determine best repair method and source matching materials' },
    { step: '03', title: 'Professional Repair', description: 'Execute seamless repair with pattern matching' }
  ],
  benefits: [
    'Cost-effective alternative to full replacement',
    'Invisible repairs that blend seamlessly',
    'Preserve original wallpaper character',
    'Quick turnaround for most repairs'
  ]
};

export default function WallpaperRepairPage() {
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center gap-4 mb-6">
              ...
              <span className="text-alba-gold font-semibold text-sm tracking-wider uppercase">Repair Services</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-alba-charcoal/80 text-lg">
              Professional wallpaper repair with attention to detail
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-alba-charcoal/80 mb-12">
              We provide wallpaper repair services across London, Hertfordshire, and the M25 area
            </p>
      ...
      <section className="py-20 md:py-28 bg-alba-primary text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-display text-heading-mobile md:text-5xl font-bold mb-6">
            Need Wallpaper Repairs?
          </h2>
          <p className="text-subheading-mobile text-alba-cream/90 max-w-2xl mx-auto mb-8">
            Contact Alba Homes today for expert wallpaper repair services in London and Hertfordshire.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button onClick={handleGetQuote} className="bg-alba-gold hover:bg-alba-accent text-alba-primary font-semibold">
              Get Free Quote
